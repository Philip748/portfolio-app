    ...
    return(
        <div className="contentDiv">
            <div id="aboutMeDiv">
                ...
                <form action='http://localhost:3000/CV.pdf' target="_blank">
            ...
            <div id="projectsDiv">
                ...
                <Project title={"Military Grid Reference System"} image={MGRSImg} link={"https://gla-my.sharepoint.com/personal/2461352f_student_gla_ac_uk/_layouts/15/stream.aspx?id=%2Fpersonal%2F2461352f%5Fstudent%5Fgla%5Fac%5Fuk%2FDocuments%2FMicrosoft%20Teams%20Chat%20Files%2FCS16%20Demo%20%281%29%2Emp4&referrer=Teams%2ETEAMS%2DELECTRON&referrerScenario=p2p%5Fns%2Dbim&ga=1"} text={"This Military Grid Reference System comes from a third year project where me and three other students worked with a customer in an agile team setting. Our customer was aerospace company Thales. This project taught me a great deal on working effectively within a team. My main contributions to this app where implementing the 'Shape drawing', the 'map overlays' and acting as 'chair' for out customer meetings."}/>
